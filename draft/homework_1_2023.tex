...
\medskip
\noindent {\bf 1.} Please describe a decision problem whose optimal value is given by a function $v(w)$ that
...
\noindent{\bf 2.} Please describe a decision problem whose optimal value is given by a function $v(w)$ that
satisfies the following equations: 
...
\medskip
\noindent{\bf 3.} Let $f:[0, B] \rightarrow {\bf R}^+$ be a known probability density function for a nonnegative random variable
...
\noindent {\bf Part II}
\medskip
\noindent Please do exercises 7.8, 7.9, 7.15, and 7.16.
...
\medskip
\noindent{\bf c.} Do your findings remind you in any way of a linear state-space system?
...
\medskip
\noindent{\bf 15. Maybe too challenging}
\medskip
...
\medskip
\noindent{\bf 16. Maybe too challenging} 
