...
In our endowment economy, heterogeneous beliefs have no effect on aggregate 
consumption, but through their effects on asset trades and  equilibrium prices of  the 
...
Hence, any single individual would attain a
higher expected lifetime utility under the true
distribution by selling his asset holding
in the very first period and never trade again  
in the asset, as long as any such `deviating' 
agents do not invalidate the existence of a 
competitive equilibrium in which each type of 
agent (who continue to trade in the asset) 
...
The split of the true unconditional expected 
present value of the asset between the two types
of agents is determined by how the subjective
probabilities distort the equilibrium prices.
...
less dividends in that parameter region, the exploding 
relative spoils received by agents of type $b$ 
at the expense of agents of type $a$ are tempered
in absolute terms .
...
accurate beliefs will  have sold  continuation endowment streams to finance earlier consumption and any poor asset
trading strategy.
