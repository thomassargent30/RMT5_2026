...
\centerline{\bf  Potential Qualifier Problems}
...
\medskip
\noindent{\bf Part B.}   Where $x \in {\bf R}$, $f >0, d >0 $, $w(x)$ solves functional equation (1), and   $\beta \in (0,1)$, for what intertemporal problem is the following  a Bellman equation?
