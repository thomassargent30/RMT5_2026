...
\line{Teacher Evaluation Form \hfil NYU}
\line{September 27, 2019 \hfil Thomas Sargent}
...
\noindent{\bf Instructions:} This exam consists of  ``inverse problems'' that assert answers and invite you to state  associated questions.
 Thus, each item below is a Bellman equation for an intertemporal  optimum problem.  Your job is please to
