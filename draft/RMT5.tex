...
\nopagenumbers\hbox{}\newpage\pagenumbers  % Tom added April 12, 2018
...
% add TOC entry by hand
\Contentstrue\addTOC{0}{Preface to the fifth edition}{\folio}\Contentsfalse
\input blackin_3
\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers  %% added by Tom April 12, 2018
\pageno=0
...
%\pageno=666
%\advance\pageno by -1
%\input black1_recovery %  imported from Francois's RMT5 from mid April
\input black1a_2021   % %\use{timeseries} nontechnical overview
% %\use{timeseriesapp} nontechnical overview
%\supereject %\newpage
%\vfil\supereject
%\nopagenumbers\hbox{} \newpage \pagenumbers
%\nopagenumbers\hbox{} \pagenumbers
...
\input black1b_2024_v2 % \use{timeseriesapp}  
\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers
\input black5_2010  % \use{seach1}
\vfil\eject
% \nopagenumbers\hbox{}\newpage\pagenumbers   % Removed by Tom April 12, 2018
...
\input black7_2023_v2 %\use{recurge}
%\input black8  %\use{ogmodels}
\input black8_ver13_tom %\use{ogmodels}  
\input black9   %\use{ricardian}
%\vfil


%\def\LHeadText{\relax}}
%\nopagenumbers\hbox{}\vfil\eject}

%\pagenumbers


%%%% note to Francois: Feb 10, 2018
%% the end of black9  is where problems occur around pages 391-393
%% also the section and chapter running heads are distorted at the end of the chapter
%% We faced a similar problem in 2012 with RMT3 that you somehow solved. But it was a mystery then too
%%

\input blackpro_5_2023 %\use{linappro}  -- this is experimental, blackpro_4 is the original
%\input black_keynes
\vfil\eject
\vfil\eject
%\nopagenumbers
%  \hbox{}\newpage\pagenumbers     % %'d out, Feb 8, 2017
% \nopagenumbers\hbox{}\newpage\pagenumbers % %'d out, Feb 8, 2018

\input bgrowth2  %\use{growth1}
\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers   %% altered this triple on Feb 8, 2018
%\TOCwrite{\vfil\eject}
\input black10_part1_v5 %\use{assetpricing1}
%\vfil\eject    %%% These two lines %'d out by Tom, April 9, 2018
%\nopagenumbers\hbox{}\newpage\pagenumbers
...
\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers
\input black12_13  %\use{optax}
\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers
\advance\pageno by -1

\makepart{Part IV}{Savings Problems and
Bewley Models}
%\advance\pageno by -1
...
\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers
\input opt_tax_recur_3 %\use{optaxrecur}
\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers
...
\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers
\input black16_2026 %\use{credible}
%\vfil\eject
\nopagenumbers\hbox{}\newpage\pagenumbers
...
\input black19_2 % \use{search2}  % corrected Dec 11 2017
\input Matching_new_Lars_8 % \use{mechanics_matching}
\vfil\eject
