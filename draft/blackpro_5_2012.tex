...
A graph of $r_{t,t+s}$ against $s$ for $s=1, 2, \ldots, S$ is called the (real) yield curve at $t$. \index{expectations!theory of the term structure}%
...
\subsection{Computing an equilibrium path with the shooting algorithm}
...
Mertens and Ravn (2011) use these effects to  offer an interpretation of contractionary contributions that the Reagan tax cuts made
...
\newpage
\noindent Notice also that figure \Fg{fig1_g-2} shows an
...
foreign assets that  support  greater steady-state consumption.
...
domestic capital in the short-run, their only source of assets in the closed economy version of this experiment.
 ...
 The no-arbitrage conditions connect adjustments of both types of saving: the   increase
   in
