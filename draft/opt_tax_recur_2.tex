...
$$   x_t(s^t)  = u_c(s^t) [ n_t(s^t) - g_t(s_t)]  - u_\ell (s^t) n_t(s^t) + \beta \sum_{s_{t+1}\in {\cal S}} \Pi (s_{t+1}| s_t) x_{t+1}(s^{t+1}).
 \EQN LSA_budget1r $$
...
%L%preferences, 
authorities, and responsibilities across time    express the continuation Ramsey planners' obligations to
