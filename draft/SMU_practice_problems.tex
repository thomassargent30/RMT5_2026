...
\line{PhD Macroeconomics \hfil SMU}
\line{February 6, 2020 \hfil Thomas Sargent}
...
\noindent{\bf Instructions:} This document contains some``inverse problems'' that assert answers and invite you to state  associated questions.
 Each such item presents a Bellman equation for an intertemporal  optimum problem.  Your job is please to
...
\medskip
\noindent{\bf 12. Somewhat difficult.} Under government policy number 1, a consumer's non-financial income $\{y_t\}_{t=0}^\infty$  is described by the state-space system
...
\medskip
\noindent {\bf 13.} Consider the following model of a monopolist.  Let  $S_t$ be sales at time $t$, $Q_t$ be production output at time $t$,
...
\medskip
\noindent{\bf 14.} Let $C(Q) = c_1 Q + c_2 Q^2$ where $c_1, c_2 > 0$; $d(I, S) = d_1 I + d_2 I^2 + d_3 (S - I)^2$ where $d_1>0, d_2 >0, d_3 >0$; 
...
\medskip
\noindent{\bf 15. Somewhat challenging}
\medskip
