...
\noindent Given the policy parameters $(g,\tau,\tau_0,B)$, the initial
...
\auth{Bryant, John}%
\auth{Wallace, Neil}%
\auth{Velde, Fran\c cois}%
 \index{legal restrictions!Terror}%
...
\itemitem{1.}  the currency of country 2 is worthless
                               ($e=0$ and $p_{2t}=\infty, \forall t\geq0$);
\itemitem{2.}  the two currencies are traded one for one
                               ($e=1$ and $p_{1t}=p_{2t}, \forall t\geq0$);
\itemitem{3.}  the currency of country 1 is worthless
...
will be satisfied for a given  \newpage \noindent fiscal    policy. Bassetto provides
