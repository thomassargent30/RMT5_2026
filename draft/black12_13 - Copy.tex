...
In a monetary economy in which  a government  can issue and trade only
...
Returning to a nonmonetary, nonstochastic growth model,
Jones, Manuelli, and Rossi (1997)
augment the setup by allowing human capital accumulation. They
...
and $n_0(s^0)$ from  first-order conditions \Ep{TSs_foc;c} and \Ep{TSs_foc;d}, respectively. Again, the elimination of multiplier
$\theta_0(s^0)$ and invokation of resource constraint yields an
...
as above to compute $c_t(s^t), n_t(s^t)$ for $t \geq 0$ and all $s^t$.
...
In order to eliminate  taxes and prices and thereby  express
...
It is instructive to elaborate on two realizations of such a  state-contingent-debt
economy   in which  time-invariant multipliers satisfy  $\Phi=0$ and
$\Phi = \Psi_0+\gamma_T$, respectively, two economies whose tail allocations
...
\subsection{The case of sticky prices}
