...
a list of each agent $i$'s consumption at every date $t$ and 
all histories $s^t$, 
$\{{\bf c}^i\}_i=\{\{c_t^i(s^t)\}_{t\geq0,\,s^t}\}_i$.
...
prices $\{q_t(s^t)\}_{t\geq0,\,s^t}$, a price for each 
...
a new asset by breaking it into a sequence of history-contingent
...
of a claim to a random payoff $\omega_{\tau+1}(s_{\tau+1})$, 
we use
