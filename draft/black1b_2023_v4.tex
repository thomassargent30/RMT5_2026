...
% $w_{t+1}$, let  denote consumer $i$'s vector 
% of shocks.
...
expectations on
the right side of the second line.%  the budget constraint. 
After 
...
consumption level $\bar c^i$. Differences in $b(z^i_{t}, \bar c)$ across 
...
economy. Consumers in the 
incomplete markets economy attain  lower
expected utility than they do in the complete markets economy since, while  their consumption varies
