...
Because $\beta < 1, $ it follows that $c_0 \in (.5, 1)$.  To
...
From equation \Ep{od9}, it follows that for $\beta < 1$, $c_0 > 0.5$ and $1-c_0 < 0.5$.
...
is $1-c_0 -g$.  Thus,
$(1-c_0)R = (1-c_0-g)$, which implies that
...
\topfigure{bryant4f}
\centerline{\epsfxsize=2.75truein\epsffile{bryant4.eps}}
...
\midfigure{bryant5f}
\centerline{\epsfxsize=2.75truein\epsffile{bryant5.eps}}
...
\noindent This section adapts ideas of Bryant and Wallace (1984)  and Villamil (1988) to the turnpike environment.
...
%pushes the agent onto lower and lowe two-period budget sets.}$$
%}\endinsert
%%%%%%%%%%%%%%%%%%%%%
...
agent onto lower  two-period budget sets.}
\infiglist{silverf}
\endfigure
