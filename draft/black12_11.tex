...
=(1+\Phi) &u_{\ell}(c_0,1-c_0-g_0) 
         + \Phi \bigl[c u_{c\ell}(c_0,1-c_0-g_0) \cr
...
$$   u_{c,0} b_0 = u_{c,0} (n_0 - g_0) - u_{\ell,0} n_0  + \beta \sum_{s=1}^S \Pi(s | s_0) x(s) \EQN Bellman2consr $$
...
will be a time-invariant allocation $c,n$ for $t\geq 1$, determined 
by condition \Ep{TS_barg}, and possible different values $c_0,n_0$
