...
$$ \beta^t u'_i[c_t^i(s^t)] \pi_t(s^t) = \mu_i q_t(s^t). \EQN eq3 $$


We use the following  definitions:
\medskip
\noindent{\sc Definitions:}   A {\it price system} is a sequence of
functions $\{q_t(s^t)\}_{t=0}^\infty$.  An {\it allocation} is
a list of sequences of functions ${\bf c}^i=\{c_t^i(s^t)\}_{t=0}^\infty$,
 one for each $i$.
\medskip
...
is $S = \{0, .5, 1\}$ and  
uncertainty is termporary in the following sense.  
