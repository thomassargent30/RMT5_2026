...
where the probability distribution of $x_t$ condition on $y^{t-1}$ is ${\cal N}(\hat x_t, \Sigma_t)$. Thus, 
...
Markov chains and stochastic linear difference equations. 
Much of this book 
is devoted to providing good examples of the saying that ``finding the state is an art''.
To kick off the process of displaying applications, chapter
\use{timeseriesapp} presents some classic applications of the linear state
space tools we have learned in this chapter. 
