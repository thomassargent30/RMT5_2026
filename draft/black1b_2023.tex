...
By adapting ideas of   Truman Bewley (1977, 1980) to the currenty setting, there is a way to fill out 
the  consumer's environment  that makes  $R = \beta^{-1}$ is an equilibrium outcome.  
...
non-financial incomes are independent draws from the stationary distribution  of stheir common statistical model \Ep{sprob15}, and that their initial financial wealth levels $b_0$  all equal  $0$. Our assumption about the initial distribution of non-financial incomes implies that the cross-section average of non-financial income equals the mean of its  stationary distribution each period.   
Since we are now analyzing a closed economy, it follows that the cross-section mean of consumption equals the stationary mean of non-financial income each period.  But what about higher moments of the cross-section distribution of consumption? 
...
constand grows interest rate $R = \beta^{-1}$. At this interest rate,  appropriate weighted sums of one-period risk-free borrowing equal  appropriate weighted sums of one-period risk free lending at each $t \geq 0$. 
...
$R = \beta^{-1}$.
Across all consumers, risk-free loans are in zero excess supply.
We have arranged primitives so that $R = \beta^{-1}$ clears the market for risk-free loans at zero aggregate excess supply each period. 
