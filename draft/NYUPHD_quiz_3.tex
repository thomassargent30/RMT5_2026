...
\medskip
\noindent{\bf Instructions:} Here are some more ``fun'' practice problems.
...
\medskip
\noindent {\bf 1.} Consider the following model of a monopolist.  Let  $S_t$ be sales at time $t$, $Q_t$ be the monopolist's production  at time $t$,
...
\medskip
\noindent{\bf 2.} Let $C(Q) = c_1 Q + c_2 Q^2$ where $c_1, c_2 > 0$; $d(I, S) = d_1 I + d_2 I^2 + d_3 (S - I)^2$ where $d_1>0, d_2 >0, d_3 >0$; 
...
\medskip
\noindent{\bf 3.} This is an exercise about the meaning of ``i.i.d.''
\medskip
...
\medskip 
\noindent{\bf e.} Under the ``model'' implied by $G, F, s_0$, is $\{w_t\}_{t=0}^\infty$ an independently and identically distributed sequence of random variables?
